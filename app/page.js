    ...
    <>
      <header>
        <a href="#" className="logo-holder">
          ...
          <div className="logo-text">Quddus Portfolio</div>
        </a>
        <nav>
          ...
          <div className="chatbot-blue">
            ...
            <div  className="chat-box">
                    ...
                    <li key={index} className={`${message.role}`}>
                      ...
                      <div className="message">
                        ...
                        {message.role === 'assistant' && (
                          <button onClick={() => readAloud(message.content)} className="read-aloud-button">
              ...
              <form onSubmit={submitForm} className="chat-message">
                ...
                <button type="button" className="button black" onClick={handleStartStop}>
                  <FontAwesomeIcon icon={listening ? faStopCircle : faMicrophone} />
                </button>
              </form>
            </div>
          </div>
